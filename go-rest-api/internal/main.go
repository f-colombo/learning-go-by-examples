...
import (
	...
	"github.com/f-colombo/learning-go-by-examples/go-rest-api/pkg/swagger/server/restapi"
	"github.com/f-colombo/learning-go-by-examples/go-rest-api/pkg/swagger/server/restapi/operations"
...
func GetGopherByName(gopher operations.GetGopherNameParams) middleware.Responder {
	...
	if gopher.Name != "" {
		URL = "https://github.com/f-colombo/gophers/raw/main/" + gopher.Name + ".png"
	} else {
		// by default we return dr who gopher
		URL = "https://github.com/f-colombo/gophers/raw/main/dr-who.png"
	}
